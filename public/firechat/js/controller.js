webChat.controller('buyCtrl',['$scope', '$http', '$routeParams', '$location', '$anchorScroll', '$timeout', '$q',function($scope, $http, $routeParams, $location, $anchorScroll, $timeout, $q){
	...
	$scope.getDetails = function(){
		...
		$http.post('http://52.221.57.201/dev/public/api_queries_chat',data).then(function(response){
    ...
    /*$scope.getdata = function(page){
        ...
        $http.post('http://52.221.57.201/dev/public/api_queries_chatrefresh',data).then(function(response){
    ...
    /*window.onscroll = function(ev)
{
	...
	$scope.sendMessage = function()
	{
        if($scope.sendMessageData!='')
        {
    		...
    		$scope.sendMessageData = '';
    		console.log(data);
    		$http.post('http://52.221.57.201/dev/public/api_queries_chatinsert',data).then(function(response){
    			//console.log(response.data);
    			$scope.sendMessageData = '';
    			$scope.getdataRf();
