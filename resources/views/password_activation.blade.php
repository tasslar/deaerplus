...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <title>DealerPlus-Password Activation</title>
    ...
    <![endif]-->
        <style type="text/css">
            #activepassword label.error{
                color:red;
            }
            #activepassword input.error{
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            ...
                            <div class="well row pt-2x pb-3x bk-light mb-4x">
                                ...
                                <div class="col-md-8 col-md-offset-2">
                                    <form id="activepassword" action="{{url('passwordconfirm')}}" method="POST" class="mt">
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        <input type="hidden" name="id" value="<?php echo $id; ?>">
                                        <label for="" class="text-uppercase text-sm">New Password</label>
                                        <input type="password" name="newpassword" maxlength="16" placeholder="New Password" class="form-control mb data-password" >
                                        <br/>
