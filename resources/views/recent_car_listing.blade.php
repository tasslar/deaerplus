                ...
                <div class="row">
                    <div class="content-header col-sm-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Recent cars</li>
                        </ol>
                    </div>
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-12 col-md-12 col-sm-12">
                            ...
                            <ul id="listing">
                                @if(!empty($compact_array['saveddata']))
                                    @foreach($compact_array['saveddata'] as $document)
                                                ...
                                                <div class="row searchbtns">
                                                    <div class="pull-right col-xs-12 col-md-8 ">
                                                        <ul class="view-buttons row">
                                                            ...
                                                            <li><a class="btn all-list-btn btn-sm btn-primary" data-make='{{$document["make_id"]}}' data-model='{{$document["model"]}}' data-variant='{{$document["variant"]}}'>View Similar</a></li>
