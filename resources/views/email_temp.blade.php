...
<div class="content-wrapper myprofile">
    <div class="container-fluid footer-fixed">
        ...
        <div class="col-xs-12">
            <h2 class="page-title col-sm-8">Email Template</h2>
            <a href="{{url('addemailtemplate')}}" class="pull-right col-sm-3 col-xs-12 btn btn-primary add-list">New Email Template</a>
