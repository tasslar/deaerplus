	...
	var Cropit = (function () {
	  ...
	  _createClass(Cropit, [{
	    ...
	    value: function init() {
	      ...
	      this.$image = (0, _jquery2['default'])('<img ng-pinch-zoom />').addClass(_constants.CLASS_NAMES.PREVIEW_IMAGE).attr('alt', '').css({
	      ...
	      if (this.options.imageBackground) {
	        ...
	        this.$bg = (0, _jquery2['default'])('<img ng-pinch-zoom />').addClass(_constants.CLASS_NAMES.PREVIEW_BACKGROUND).attr('alt', '').css({
	          position: 'relative',
