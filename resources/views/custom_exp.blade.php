    ...
    <div class="brand container">
        ...
        <div class="row">
            ...
            <div class="col-sm-9"><div class="row"><span class="menu-btn"><i class="fa fa-bars"></i></span>
                    ...
                    <span class="searching-click hidden-md hidden-lg notification"><a href="#" class="msg-3-res"><i class="fa fa-bell"></i></a></span>
                    <span class="searching-click hidden-md hidden-lg notification"><a href="#" class="msg-1-res"><i class="fa fa-envelope"></i></a></span>
                    <span class="searching-click hidden-md hidden-lg notification"><a href="#" class="msg-2-res"><i class="fa fa-laptop"></i></a></span>
                </div></div>
                <div class="col-sm-10 col-xs-9 hidden-xs hidden-sm"><ul class="ts-profile-nav row">
                    ...
                    <li class="ts-account">
                        <a href="#"><img src="{{url('img/noimage.jpg')}}" class="ts-avatar hidden-side" alt="">Some error occurred. Please try again.<i class="fa fa-angle-down hidden-side"></i></a>
                        <ul>
        ...
        <div class="sys-notify col-sm-4 col-xs-12">
            <div class="row">
                ...
                <ul class="col-xs-12 col-sm-12 notify-msg">
                    <li>
                        <div class="col-xs-12 msg-not">Some error occurred. Please try again.</div>
                    </li>
                </ul>
            </div>
            <div class="row chat-button"><div class="col-sm-4 col-md-2 col-xs-12 btn btn-primary"><a href="#">Bids</a></div>
                <div class="col-sm-8 col-md-5 col-xs-12 btn btn-primary"><a href="{{url('doQueriesReceived')}}">Some error occurred. Please try again.</a></div>
